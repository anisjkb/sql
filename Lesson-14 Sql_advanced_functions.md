...
3. [Basic Window Function Examples](#basic-window-function-examples)
   - [ROW_NUMBER()](#rownumber-example)
   - [LAG()](#lag-example)
   - [Running Totals Using SUM()](#running-totals-using-sum)
4. [Additional Advanced Functions](#additional-advanced-functions)
   - [RANK() and DENSE_RANK()](#ranking-functions)
   - [LEAD()](#lead-example)
   - [NTILE(n)](#ntile-example)
   - [FIRST_VALUE() and LAST_VALUE()](#first-value-and-last-value)
